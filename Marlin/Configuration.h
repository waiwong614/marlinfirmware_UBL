...
//#define CUSTOM_MACHINE_NAME "PRUSA i3D"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Ultimaker
  #define  DEFAULT_Kp 32.58
  #define  DEFAULT_Ki 1.71
  #define  DEFAULT_Kd 154.79
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 1600, 96.241 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 2000, 2000, 15, 10000 }
...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -0.30   // latest -0.30, was -0.45 Z offset: -below +above  [the nozzle]
...
#define Z_PROBE_OFFSET_RANGE_MAX 15   // was -5
...
#define X_MIN_POS 0 // was 0
#define Y_MIN_POS 0
#define Z_MIN_POS 0
#define X_MAX_POS 200 // was 205
#define Y_MAX_POS 180 // was 200
#define Z_MAX_POS 180 // was 200
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define UBL_PROBE_PT_1_Y 30      // of the mesh.
...
//#define SERVO_ENDSTOPS {-1, -1, 0} // Servo index for X, Y, Z. Disable with -1 - uncomment for servo usage
//#define SERVO_ENDSTOP_ANGLES {0,0, 0,0, 70,180} // X,Y,Z Axis Extend and Retract angles WAS 68 - uncomment for servo usage
